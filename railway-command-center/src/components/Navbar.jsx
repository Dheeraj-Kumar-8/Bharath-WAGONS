          ...
          <div ref={profileRef} style={{ position:"relative" }}>
            ...
            >
              ...
              <div style={{ textAlign:"left" }}>
                <div style={{ color:"#f1f5f9", fontSize:12, fontWeight:600 }}>{admin?.name || "Admin"}</div>
                <div style={{ color:"#4a6fa5", fontSize:10 }}>Zone {admin?.zone} &middot; Admin</div>
              </div>
            ...
            {showProfile && (
              <div style={{ position:"absolute", right:0, marginTop:8, width:220, background:"#0d1f3c", border:"1px solid #1a3356", borderRadius:14, overflow:"hidden", zIndex:500, boxShadow:"0 16px 48px rgba(0,0,0,.5)" }}>
                <div style={{ padding:"12px 16px", borderBottom:"1px solid #1a3356" }}>
                  <div style={{ color:"#f1f5f9", fontWeight:700, fontSize:13 }}>{admin?.name}</div>
                  <div style={{ color:"#4a6fa5", fontSize:11, marginTop:2 }}>{admin?.email}</div>
                ...
                {[
                  { label:"Profile",  Icon:FiUser,     path:"/settings" },
