...
export const ALL_WAGONS = [
  // NR
  { id:"WGN-N01", type:"BOXN",    location:"New Delhi",   dest:"Mumbai CST",  speed:"87", status:"On Time",    capacity:"60T", zone:"NR"  },
  { id:"WGN-N02", type:"BTPN",    location:"Lucknow",     dest:"Kolkata",     speed:"81", status:"On Time",    capacity:"45T", zone:"NR"  },
  { id:"WGN-N03", type:"BCN",     location:"Patna",       dest:"New Delhi",   speed:"68", status:"Delayed",    capacity:"55T", zone:"NR"  },
  { id:"WGN-N04", type:"Hopper",  location:"Kanpur",      dest:"Delhi",       speed:"0",  status:"Maintenance",capacity:"60T", zone:"NR"  },
  { id:"WGN-N05", type:"Tank",    location:"Allahabad",   dest:"Varanasi",    speed:"74", status:"On Time",    capacity:"45T", zone:"NR"  },
  // SR
  { id:"WGN-S01", type:"BOXN",    location:"Chennai Ctrl",dest:"Hyderabad",   speed:"64", status:"Delayed",    capacity:"60T", zone:"SR"  },
  { id:"WGN-S02", type:"Tank",    location:"Coimbatore",  dest:"Bengaluru",   speed:"59", status:"On Time",    capacity:"45T", zone:"SR"  },
  { id:"WGN-S03", type:"Covered", location:"Madurai",     dest:"Chennai",     speed:"71", status:"On Time",    capacity:"55T", zone:"SR"  },
  { id:"WGN-S04", type:"BCN",     location:"Trichy",      dest:"Salem",       speed:"0",  status:"Maintenance",capacity:"60T", zone:"SR"  },
  { id:"WGN-S05", type:"BOXN",    location:"Salem",       dest:"Coimbatore",  speed:"66", status:"On Time",    capacity:"60T", zone:"SR"  },
  // ER
  { id:"WGN-E01", type:"BOXN",    location:"Howrah",      dest:"New Delhi",   speed:"92", status:"On Time",    capacity:"60T", zone:"ER"  },
  { id:"WGN-E02", type:"BTPN",    location:"Asansol",     dest:"Dhanbad",     speed:"55", status:"Delayed",    capacity:"45T", zone:"ER"  },
  { id:"WGN-E03", type:"Flatbed", location:"Durgapur",    dest:"Kolkata",     speed:"78", status:"On Time",    capacity:"55T", zone:"ER"  },
  { id:"WGN-E04", type:"BCN",     location:"Kharagpur",   dest:"Bhubaneswar", speed:"0",  status:"Maintenance",capacity:"60T", zone:"ER"  },
  { id:"WGN-E05", type:"Hopper",  location:"Malda",       dest:"Howrah",      speed:"63", status:"On Time",    capacity:"60T", zone:"ER"  },
  // WR
  { id:"WGN-W01", type:"BOXN",    location:"Ahmedabad",   dest:"New Delhi",   speed:"55", status:"Delayed",    capacity:"60T", zone:"WR"  },
  { id:"WGN-W02", type:"Tank",    location:"Surat",       dest:"Ahmedabad",   speed:"90", status:"On Time",    capacity:"45T", zone:"WR"  },
  { id:"WGN-W03", type:"Covered", location:"Vadodara",    dest:"Mumbai",      speed:"72", status:"On Time",    capacity:"55T", zone:"WR"  },
  { id:"WGN-W04", type:"BCN",     location:"Rajkot",      dest:"Surat",       speed:"0",  status:"Maintenance",capacity:"60T", zone:"WR"  },
  { id:"WGN-W05", type:"BTPN",    location:"Bharuch",     dest:"Vadodara",    speed:"68", status:"On Time",    capacity:"60T", zone:"WR"  },
  // NER
  { id:"WGN-NE1", type:"BOXN",    location:"Guwahati",    dest:"Kolkata",     speed:"61", status:"On Time",    capacity:"60T", zone:"NER" },
  { id:"WGN-NE2", type:"Tank",    location:"Dibrugarh",   dest:"Guwahati",    speed:"48", status:"Delayed",    capacity:"45T", zone:"NER" },
  { id:"WGN-NE3", type:"Covered", location:"Silchar",     dest:"Lumding",     speed:"54", status:"On Time",    capacity:"55T", zone:"NER" },
  { id:"WGN-NE4", type:"BCN",     location:"Jorhat",      dest:"Dibrugarh",   speed:"0",  status:"Maintenance",capacity:"60T", zone:"NER" },
  { id:"WGN-NE5", type:"Hopper",  location:"Tinsukia",    dest:"Guwahati",    speed:"57", status:"On Time",    capacity:"60T", zone:"NER" },
  // NWR
  { id:"WGN-NW1", type:"BOXN",    location:"Jaipur",      dest:"Delhi",       speed:"79", status:"On Time",    capacity:"60T", zone:"NWR" },
  ...
  { id:"WGN-NW4", type:"BTPN",    location:"Udaipur",     dest:"Ahmedabad",   speed:"58", status:"Delayed",    capacity:"60T", zone:"NWR" },
  { id:"WGN-NW5", type:"BCN",     location:"Kota",        dest:"Mumbai",      speed:"83", status:"On Time",    capacity:"60T", zone:"NWR" },
  // SER
  { id:"WGN-SE1", type:"BOXN",    location:"Bhubaneswar", dest:"Kolkata",     speed:"76", status:"On Time",    capacity:"60T", zone:"SER" },
  { id:"WGN-SE2", type:"Tank",    location:"Vizag",       dest:"Chennai",     speed:"0",  status:"Maintenance",capacity:"45T", zone:"SER" },
  { id:"WGN-SE3", type:"Hopper",  location:"Raipur",      dest:"Nagpur",      speed:"69", status:"On Time",    capacity:"55T", zone:"SER" },
  { id:"WGN-SE4", type:"BCN",     location:"Bilaspur",    dest:"Raipur",      speed:"52", status:"Delayed",    capacity:"60T", zone:"SER" },
  { id:"WGN-SE5", type:"BTPN",    location:"Sambalpur",   dest:"Bhubaneswar", speed:"73", status:"On Time",    capacity:"60T", zone:"SER" },
  // SWR
  { id:"WGN-SW1", type:"BOXN",    location:"Bengaluru",   dest:"Chennai",     speed:"78", status:"On Time",    capacity:"60T", zone:"SWR" },
  { id:"WGN-SW2", type:"Tank",    location:"Mysuru",      dest:"Bengaluru",   speed:"62", status:"On Time",    capacity:"45T", zone:"SWR" },
  { id:"WGN-SW3", type:"Covered", location:"Hubballi",    dest:"Pune",        speed:"0",  status:"Maintenance",capacity:"55T", zone:"SWR" },
  { id:"WGN-SW4", type:"BCN",     location:"Belagavi",    dest:"Hubballi",    speed:"55", status:"Delayed",    capacity:"60T", zone:"SWR" },
  { id:"WGN-SW5", type:"BTPN",    location:"Mangaluru",   dest:"Bengaluru",   speed:"70", status:"On Time",    capacity:"60T", zone:"SWR" },
];
